...
import com.example.root.mytry1.camera.CameraManager;
import com.example.root.mytry1.common.BitmapUtils;
import com.example.root.mytry1.decode.BitmapDecoder;
import com.example.root.mytry1.decode.CaptureActivityHandler;
import com.example.root.mytry1.view.ViewfinderView;
...
public final class CaptureActivity extends Activity implements
					...
					new Thread(new Runnable() {
						...
						public void run() {
							...
							if (result != null) {
								...
								goantheractivity(m.obj.toString());
	...
	public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
		...
		goantheractivity(ResultParser.parseResult(rawResult).toString());
	...
	public  void goantheractivity (String url){
		String equipment;
		String simulation;
		//url.split('P');
		simulation=url.substring(0,2);
		equipment=url.substring(2);

		Log.i(TAG,simulation+"@@@@"+equipment);

		//startActivity(new Intent(CaptureActivity.this, ShowEquipActivity.class));
		Intent i= new Intent(CaptureActivity.this, ShowEquipActivity.class);
		i.putExtra("equipment",equipment);//传递参数
